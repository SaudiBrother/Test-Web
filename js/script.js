...
const elements = {
    ...
    themeToggleFacts: document.getElementById('themeToggleFacts'),
    ...
    dayButtons: document.querySelectorAll('.day-btn-compact'),
...
function showScreen(screenName) {
    ...
    // Sembunyikan expanded state tombol kembali
    elements.backContainer.classList.remove('expanded');
}
...
function controlBackButton(show, targetScreen = null) {
    if (show) {
        ...
        elements.fixedBackButton.onclick = () => {
            if (targetScreen) {
        ...
        elements.fixedBackButton.onclick = null;
    }
}
...
function adjustScheduleContainer() {
    ...
    const headerHeight = document.querySelector('.schedule-header').offsetHeight;
...
function setupEventListeners() {
    ...
    elements.themeToggleFacts.addEventListener('click', toggleTheme);
    ...
    elements.backArrow.addEventListener('click', function() {
        elements.backContainer.classList.toggle('expanded');
    });
    
    // Tutup expanded state saat klik di luar
    document.addEventListener('click', (e) => {
        if (!elements.backContainer.contains(e.target) && 
            elements.backContainer.classList.contains('expanded')) {
            elements.backContainer.classList.remove('expanded');
        }
    });
    ...
    window.addEventListener('resize', () => {
        if (screens.scheduleDisplay.classList.contains('active')) {
            adjustScheduleContainer();
        }
    });
}
...
function init() {
    ...
    console.log('Back container:', elements.backContainer);
}
